...
const SlideNextSteps = () => {
  return (
    <SlideShell title="Next Steps" className="grid-rows-2">
      <Card className="flex flex-col justify-center space-y-5 p-5 h-full col-span-2 relative overflow-hidden">
        <Noise />
      ...
      <Card className="flex flex-col items-center justify-center space-y-5 p-5 h-full col-span-3 relative overflow-hidden">
